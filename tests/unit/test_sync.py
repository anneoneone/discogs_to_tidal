...
from discogs_to_tidal.core.models import Track, Album, Artist, SyncResult  # noqa: E402
from discogs_to_tidal.core.exceptions import (  # noqa: E402
    AuthenticationError, SyncError
)
...
class TestSyncService(unittest.TestCase):
    ...
    def test_sync_collection_success_integration(
        self, mock_handle_playlist, mock_process_albums,
        mock_fetch_albums, mock_init_session
    ):
        ...
        result = sync_service.sync_collection(
            playlist_name="Integration Test",
            folder_id=0
        )
